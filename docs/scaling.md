...
ab -n 10000 -c 100 https://api.ultimatestats.co.ke/api/v1/matches
```
...
export default function () {
  let res = http.get('https://api.ultimatestats.co.ke/api/v1/matches');
...
class GameStatsUser(HttpUser):
    ...
    host = "https://api.ultimatestats.co.ke"
